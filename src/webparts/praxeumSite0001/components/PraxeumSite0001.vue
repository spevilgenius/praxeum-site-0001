<template>
    <div :class="$style.PraxeumSite0001">
 ...
 */
export interface IPraxeumSite0001Props {
    description: string;
}
 ...
 */
@Component
export default class PraxeumSite0001 extends Vue implements IPraxeumSite0001Props {
